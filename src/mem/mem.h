...
RISA_API void* risa_mem_alloc   (size_t size, const char* file, uint32_t line);
RISA_API void* risa_mem_realloc (void* ptr, size_t size, size_t unitSize, const char* file, uint32_t line);
RISA_API void* risa_mem_expand  (void* ptr, size_t* size, size_t unitSize, const char* file, uint32_t line);
